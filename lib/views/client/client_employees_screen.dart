...
import 'package:consultation_app/views/client/add_consultation_screen.dart';
...
class ClientEmployeesScreen extends StatefulWidget {
  ...
  @override
  State<ClientEmployeesScreen> createState() => _ClientEmployeesScreenState();
}

class _ClientEmployeesScreenState extends State<ClientEmployeesScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _employeeViewModel.fetchActiveEmployees(widget.category.id!);
    });
  }
      ...
      body: Consumer<EmployeeViewModel>(
        builder: (context, employeeViewModel, child) {
          return RefreshIndicator(
            ...
            backgroundColor: kBackgroundColor,
            onRefresh: () async {
              await employeeViewModel.fetchActiveEmployees(widget.category.id!);
            },
